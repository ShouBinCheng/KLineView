...
enum KLinePeriod {
    ...
    fileprivate static var periods: [String] {
        return ["分时","1分","5分","15分","30分",
                "1小时","2小时","4小时","6小时","12小时",
                "日线","周线"]
    }
    
    fileprivate static var kPeriods:[KLinePeriod] {
        return [.periodTimeLine,.periodMinute_1,.periodMinute_5,
