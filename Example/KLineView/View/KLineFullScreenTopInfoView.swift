...
class KLineFullScreenTopInfoView: BaseView {
    ...
    private lazy var priceLabel:UILabel = {
        ...
        let priceLabel = UILabel.create(text: "------", font: UIFont(name: "DINAlternate-Bold", size: 20), color: UIColor(hexString: "#F2334F"))
        return priceLabel
    }()
    
    /// 约等于（法钱）
    private lazy var moneyLabel:UILabel = {
        let moneyLabel = UILabel.create(text: "----", font: UIFont(name: "DINAlternate-Bold", size: 12), color: UIColor(hexString: "#8E9AB5"))
        return moneyLabel
    }()
    
    /// 涨跌幅
    private lazy var percentLabel:UILabel = {
        let percentLabel = UILabel.create(text: "----", font: UIFont(name: "DINAlternate-Bold", size: 12), color: UIColor(hexString: "#F2334F"))
        return percentLabel
    }()
    ...
    private lazy var highDescrLabel:UILabel = {
        ...
        let highDescrLabel = UILabel.create(text: "高:", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return highDescrLabel
    }()
    private lazy var highLabel:UILabel = {
        let highLabel = UILabel.create(text: "----", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return highLabel
    }()
    
    /// 最低价
    private lazy var lowDescrLabel:UILabel = {
        let lowDescrLabel = UILabel.create(text: "低:", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return lowDescrLabel
    }()
    private lazy var lowLabel:UILabel = {
        let lowLabel = UILabel.create(text: "----", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return lowLabel
    }()
    
    /// 成交量
    private lazy var volumeDescrLabel:UILabel = {
        let volumeDescrLabel = UILabel.create(text: "24h成交量:", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return volumeDescrLabel
    }()
    private lazy var volumeLabel:UILabel = {
        let volumeLabel = UILabel.create(text: "----", font: UIFont(name: "PingFangSC-Regular", size: 10), color: UIColor(hexString: "#8E9AB5"))
        return volumeLabel
    }()
